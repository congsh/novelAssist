...
### 新增
- 编辑器AI助手功能
  - 文本润色功能：选择文本并使用AI进行润色
  - 文本续写功能：在光标位置使用AI续写内容
  - 角色提取功能：从文本中提取角色信息并创建角色
  - 地点提取功能：从文本中提取地点信息并创建地点
  - 大纲更新功能：分析章节内容并更新大纲
  - 时间线添加功能：从文本中提取事件信息并添加到时间线
- 文本差异对比组件：显示AI修改前后的文本差异
- AI编辑历史记录：保存AI修改历史并支持查看

### 修改
- 优化编辑器界面，添加AI助手抽屉
- 改进AI服务架构，支持编辑器特定功能
- 更新AI类型定义，添加编辑器操作相关类型
